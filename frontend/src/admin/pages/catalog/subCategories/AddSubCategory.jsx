...
export default function AddSubCategory() {
  ...
  if (loading) {
    return <div className="p-6 text-center text-gray-500">Loading parent categories...</div>;
  }

  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Add Sub Category</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            ...
            <select
              ...
              className="w-full border rounded-lg p-3 mt-1 bg-white outline-none focus:border-green-500"
              required
            >
