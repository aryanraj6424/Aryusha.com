...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5EEFF] to-[#EDE2FF] flex items-center justify-center p-3 sm:p-6 md:p-8">
      <div className="w-full max-w-6xl bg-white rounded-3xl sm:rounded-[40px] overflow-hidden shadow-2xl grid lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center p-4 sm:p-8 lg:p-10">
          <div className="w-full max-w-md">
            ...
            <div className="mt-5 sm:mt-8 bg-white border border-purple-100 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl">
              ...
              <form onSubmit={handleSubmit} className="mt-5 sm:mt-8 space-y-4 sm:space-y-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Enter phone number"
                    className="w-full mt-1.5 sm:mt-2 p-3 sm:p-4 text-sm sm:text-base rounded-xl sm:rounded-2xl border border-purple-200 outline-none focus:border-purple-600 transition"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 sm:py-4 rounded-xl sm:rounded-2xl bg-gradient-to-r from-purple-600 to-violet-700 text-white font-semibold text-base sm:text-lg cursor-pointer hover:opacity-95 transition shadow-md disabled:opacity-60"
                >
