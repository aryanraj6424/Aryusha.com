...
export default function AddProductFamily() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(
        `${import.meta.env.VITE_API_URL}/product-families`,
        {
  ...
  if (loading) {
    return <div className="p-6 text-center text-gray-500">Loading catalog attributes...</div>;
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Add Product Family</h1>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full mt-1 border rounded-lg p-3 outline-none focus:border-green-500"
              required
            />
          </div>
        ...
        >
          {saving ? "Saving..." : "Save Product Family"}
        </button>
      </form>
    </div>
  );
